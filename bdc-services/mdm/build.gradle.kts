/*
 * bdc-mdm · 主数据（师生/部门/课程/专业/组织/校历等）
 *
 * P0.1.2 占位：声明 application 形态，启动类与依赖将在 P4.1 阶段落地。
 */
...
description = "bdc-mdm : 主数据（师生/部门/课程/专业/组织/校历等）"

application {
    mainClass.set("com.bdc.mdm.MdmApplication")
}
...
tasks.named<JavaExec>("run") {
    systemProperty("server.port", "8104")
}