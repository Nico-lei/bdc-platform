/*
 * bdc-tag · 标签中心（规则/统计/算法标签）
 *
 * P0.1.2 占位：声明 application 形态，启动类与依赖将在 P4.3 阶段落地。
 */
...
description = "bdc-tag : 标签中心（规则/统计/算法标签）"

application {
    mainClass.set("com.bdc.tag.TagApplication")
}
...
tasks.named<JavaExec>("run") {
    systemProperty("server.port", "8106")
}